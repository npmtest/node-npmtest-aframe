...
<html lang="en">
<head>
    <title>Code coverage report for node-npmtest-aframe/node_modules/aframe/src/lib/three.js</title>
    <meta charset="utf-8">
    <style>
        body, html {
            margin:0; padding: 0;
...
<div class="header high">
    ...
    <h1>Code coverage report for <span class="entity">node-npmtest-aframe/node_modules/aframe/src/lib/three.js</span></h1>
    <h2>
    ...
    <div class="path"><a href="../../../../../index.html">All files</a> &#187; <a href="index.html">node-npmtest-aframe/node_modules/aframe/src/lib/</a> &#187; three.js</div>
</div>
<div class="body">
...
<span class="cline-any cline-yes">1</span>
<span class="cline-any cline-neutral">&nbsp;</span>
<span class="cline-any cline-neutral">&nbsp;</span></td><td class="text"><pre class="prettyprint lang-js">var THREE = global.THREE = require('three');
&nbsp;
// Allow cross-origin images to be loaded.
&nbsp;
// This should not be on `THREE.Loader` nor `THREE.ImageUtils`.
// Must be on `THREE.TextureLoader`.
<span class="missing-if-branch" title="else path not taken" >E</span>if (THREE.TextureLoader) {
  THREE.TextureLoader.prototype.crossOrigin = 'anonymous';
}
&nbsp;
// This is for images loaded from the model loaders.
<span class="missing-if-branch" title="else path not taken" >E</span>if (THREE.ImageLoader) {
  THREE.ImageLoader.prototype.crossOrigin = 'anonymous';
}
&nbsp;
// In-memory caching for XHRs (for images, audio files, textures, etc.).
<span class="missing-if-branch" title="else path not taken" >E</span>if (THREE.Cache) {
